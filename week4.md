...
# Week 4 – Initial System Configuration & Security SetUp
...
The main aim for this week were:

- Creating and managing a secure non-root administrative user for daily administration
- Enabling and configuring the UFW firewall to restrict unnecessary network access
- Hardening SSH access by disabling direct root login to reduce attack risk
...
I created a non-root administrative user called student to handle day-to-day administration tasks, since using the root account for regular work carries unnecessary security risks.
...
The SSH service was restarted in order to apply the security configuration.
...
- Generate and manage user accounts with correct privilege levels  
- Make use of UFW to protect the server from unauthorized access  
